...
@Autowired
    ...
    @PostMapping("/savedata")
            public String saveRecord( @Valid @ModelAttribute("stud") Student thestu){
...
public String show(@PageableDefault (size=8) Pageable pageable, Model model){
    Page <Student>studentPage=studentImp.getRecord(pageable);
    model.addAttribute("show",studentPage);
    return "displayalldata";
}
